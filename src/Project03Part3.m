...
%Program: Solution for AAS, T1.2019, Project3.Part3

function Project03Part3
    ...
    for i=1:IMU.N-1
        ...
        Xe = Xe + Dt*[Velocity(i)*cos(Xe(3)); Velocity(i)*sin(Xe(3)); YawRate(i)-bias];
        
        J = [1,0,-Dt*Velocity(i)*sin(Xe(3)); 
             0,1, Dt*Velocity(i)*cos(Xe(3)); 
             0,0,          1         ];
        Fu = [Dt*cos(Xe(3)), 0; 
              Dt*sin(Xe(3)), 0; 
              0              Dt];
